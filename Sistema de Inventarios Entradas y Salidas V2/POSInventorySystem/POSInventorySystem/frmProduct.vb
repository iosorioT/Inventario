...
Public Class frmProduct
    ...
    Public Sub LoadProducts(ByVal sqL As String)
        Try
            ConnDB()
    ...
    Private Sub frmProduct_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sqL = "SELECT ProductNo, ProductCOde, P.Description, Barcode, UnitPrice, StocksOnHand, ReorderLevel, CategoryName FROM product as P, category as C WHERE C.CategoryNo = P.CategoryNo ORDER BY P.Description ASC; "
        LoadProducts(sqL)
