...
Public Class frmStockIn
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        AddStockIn()
        sqL = "SELECT ProductNo, ProductCOde, P.Description, Barcode, UnitPrice, StocksOnHand, ReorderLevel, CategoryName FROM product as P, category as C WHERE C.CategoryNo = P.CategoryNo AND P.Description ORDER BY P.Description ASC; "
        frmProduct.LoadProducts(sqL)
        Me.Close()
    End Sub
